...
def test_quickstart_runs_all_three_legs(client, quickstart_ready, capable_hardware, monkeypatch, tmp_path):
...
def test_quickstart_skips_satisfied_legs(client, quickstart_ready, capable_hardware, monkeypatch):
