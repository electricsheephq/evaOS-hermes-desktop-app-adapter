...
<<<<<<< HEAD:tests/test_state_db_write_durability.py
...
||||||| 939e45c91d:tests/test_state_db_write_durability.py
def test_repair_path_has_no_bare_connects() -> None:
    """No repair/probe site may bypass the durability helper.
...
=======
>>>>>>> f97608f178:tests/hermes_state/test_state_db_write_durability.py
