...
<<<<<<< HEAD:tests/agent/test_compression_stall_fallback_78981.py
def _run(
    worker,
    *,
    chain,
...
||||||| 939e45c91d:tests/agent/test_compression_stall_fallback_78981.py
...
>>>>>>> f97608f178:tests/agent/test_compression_stall_fallback.py
