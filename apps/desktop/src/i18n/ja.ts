  ...
  boot: {
    ...
    failure: {
      ...
      managedAssignmentHint:
        'ビジネスの割り当ては Electric Sheep が選択します。アクセスが変更または取り消された場合は、もう一度サインインしてください。',
      managedSignInFailed: '管理アクセスにサインインできませんでした。もう一度お試しください。',
  ...
  settings: {
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        remoteDescription: 'ローカルランタイムを使用するプロファイルでのみ利用できます。',
