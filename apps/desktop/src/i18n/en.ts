...
export const en: Translations = {
  ...
  boot: {
    ...
    errors: {
      ...
      backgroundExitedDuringStartup: 'evaOS Agent background process exited during startup.',
    ...
    failure: {
      title: "evaOS Agent couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your evaOS Agent backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update evaOS Agent',
    ...
    native: {
      ...
      inputBody: 'evaOS Agent is waiting for your response.',
      turnDoneTitle: 'evaOS Agent finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to evaOS Agent defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones evaOS Agent writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while evaOS Agent is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'evaOS Agent asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while evaOS Agent was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let evaOS Agent follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what evaOS Agent is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen evaOS Agent, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'evaOS Agent checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading evaOS Agent configuration...',
    ...
    gateway: {
      ...
      intro:
        'evaOS Agent Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running evaOS Agent backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private evaOS Agent backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote evaOS Agent backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'evaOS Agent Cloud',
      cloudDesc: 'Sign in once to evaOS Agent Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'evaOS Agent Cloud',
      cloudSignIn: 'Sign in to evaOS Agent Cloud',
      cloudSignedIn: 'Signed in to evaOS Agent Cloud',
      cloudNeedsSignIn: 'Sign in to evaOS Agent Cloud to discover the agents on your account.',
      ...
      cloudNoAgents: {
        ...
        linkText: 'Electric Sheep account',
        after: ', then refresh.'
      },
      cloudRefresh: 'Refresh',
      cloudConnect: 'Connect',
      cloudConnecting: 'Connecting…',
      cloudDiscoverFailed: 'Could not load your evaOS Agent Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'evaOS Agent Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of evaOS Agent Cloud',
      cloudSignedOutMessage: 'Cleared the evaOS Agent Cloud session.',
      ...
      restartingMessage: 'evaOS Agent Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · evaOS Agent ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. evaOS Agent runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point evaOS Agent at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      nousAuthFailed: 'Electric Sheep account sign-in did not complete',
  ...
  starmap: {
    ...
    emptyDesc: 'As evaOS Agent builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart evaOS Agent to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update evaOS Agent to generate pets.',
      backgroundHint: 'You can close this — evaOS Agent will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure evaOS Agent desktop' },
    ...
    hermesActiveSessions: (version, count) => `evaOS Agent ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent evaOS Agent environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. evaOS Agent will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the evaOS Agent backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from evaOS Agent. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    attachUrlDesc: 'evaOS Agent will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask evaOS Agent to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating evaOS Agent…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting evaOS Agent…',
    ...
    unsupportedMessage: 'This version of evaOS Agent can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of evaOS Agent is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected evaOS Agent backend is ready to install.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the evaOS Agent desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The evaOS Agent updater takes over in its own window and reopens evaOS Agent automatically when it’s done. Please don’t reopen evaOS Agent yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. evaOS Agent reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then evaOS Agent reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'evaOS Agent needs a one-time install',
    ...
    activeDesc:
      'This is a one-time setup. The evaOS Agent installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run evaOS Agent',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — evaOS Agent connects automatically',
    ...
    authorizeThere: 'Authorize evaOS Agent there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize evaOS Agent there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Electric Sheep plan.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'evaOS Agent inference gateway status',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. evaOS Agent will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'evaOS Agent is restarting...',
      askRestart: 'Ask evaOS Agent to restart the server',
      lookingRestart: taskId => `evaOS Agent is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'evaOS Agent is working in the background. Watch the preview console for progress.',
      ...
      restartFailedMessage: 'evaOS Agent could not restart the server.',
      stillWorking:
        'evaOS Agent is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'evaOS Agent is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'evaOS Agent gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). evaOS Agent won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'evaOS Agent needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'evaOS Agent needs a credential to continue.',
