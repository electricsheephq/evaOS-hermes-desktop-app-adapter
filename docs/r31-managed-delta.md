...
| Retired in r34 (PR-3) | `tests/r31_compat/`, `tests/r31_lcm_compat/` and their two CI inputs (r30.7 `d02f2467…` and hermes-lcm v0.20.0 `49e99a27…`) | retired: no fleet box runs r31; superseded by the r34 pair (`tests/r34_compat/`: predecessor r33.6 `2d10969e…`, LCM-X v0.24.1 `98ac62fe…`). The receipts above stay the r31 record. Carried forward: the state round trip (re-pointed at r33.6), and the Astra routing and managed-config guards, which need no predecessor (`tests/hermes_cli/test_astra_catalog_routing.py`, `tests/hermes_cli/test_managed_config_guards.py`). |
